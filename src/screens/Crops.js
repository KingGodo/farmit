  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        {/* Placeholder for crops list */}
        <View style={styles.cropCard}>
          <Text style={styles.cropTitle}>Maize</Text>
          <Text style={styles.cropDetails}>Planted: January 2025</Text>
        </View>
        <View style={styles.cropCard}>
          <Text style={styles.cropTitle}>Beans</Text>
          <Text style={styles.cropDetails}>Planted: February 2025</Text>
        </View>
      </ScrollView>
    </View>
  );
